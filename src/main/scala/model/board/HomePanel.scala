...
class HomePanel extends Panel {
  ...
  /** The player's character recovers 1 HP and panel do a Norma Check.
   *
   */
  def activateHomePanel(): Unit = {
    characters.foreach(_.recoverHP(1))
    //characters.foreach(_.normaCheck())
  }
